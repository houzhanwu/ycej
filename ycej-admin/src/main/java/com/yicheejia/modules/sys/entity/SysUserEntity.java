...
public class SysUserEntity implements Serializable {
	 ...
	 */
	@TableField(exist = false)
	private List<Integer> partShopIdList;
	...
	public List<Integer> getPartShopIdList() {
		return partShopIdList;
	}

	public void setPartShopIdList(List<Integer> partShopIdList) {
		this.partShopIdList = partShopIdList;
	}
