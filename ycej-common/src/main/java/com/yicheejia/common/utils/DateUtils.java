...
public class DateUtils {
	...
	public final static String DATE_TIME_YMD2 = "yyyyMMdd HH:mm:ss";
	public final static String DATE_TIME_YMD3 = "MM-dd HH:mm:ss";
    ...
    public static String formatTime2(Date date) {
    	return format(date, DATE_TIME_YMD3);
    }
    ...
    public static String getYMDDate() {
        SimpleDateFormat df = new SimpleDateFormat(DATE_PATTERN_YMD);
